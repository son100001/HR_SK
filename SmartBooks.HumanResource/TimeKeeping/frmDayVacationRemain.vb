Public Class frmDayVacationRemain
    Private Sub frmDayVacationRemain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Search()
        ...
        End If
        Dim QR As String = "exec [dbo].[sp_BangPhepNamTon] '" + Year.Text + "',1,'" + obj.Lan + "',N'" + obj.PARA_FACTORY_ID + "',N'" + obj.PARA_DEPARTMENTCODE + "',N'" + obj.PARA_SECTIONCODE + "',N'" + obj.PARA_TEAMCODE + "',N'" + obj.PARA_POSITION_ID + "','" + obj.PARA_POSITIONCATEGORY_ID + "',N'" + EmID + "'"
