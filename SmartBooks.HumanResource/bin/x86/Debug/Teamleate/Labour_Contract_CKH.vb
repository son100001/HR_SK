...
Public Class Labour_Contract_CKH
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Labour_Contract_CKH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLabour_Contract_CKH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Labour_Contract_CKH = New Labour_Contract_CKH
        rpt.Site = Me.Site
        Return rpt
    End Function
