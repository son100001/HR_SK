...
Public Class Labour_Contract_Temp
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Labour_Contract_Temp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Employee_ID As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedLabour_Contract_Temp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Labour_Contract_Temp = New Labour_Contract_Temp
        rpt.Site = Me.Site
        Return rpt
    End Function
