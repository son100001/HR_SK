...
Public Class frmTaoDieuChinhLoaiNghi
    Private Sub frmTaoDieuChinhLoaiNghi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Search()
        Dim QR As String = "select * from SmartBooks_LeaveType"
