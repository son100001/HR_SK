...
Public Class HR_Category
    Private Sub HR_Category_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Search()
        Dim QR As String = "select * from HR_Category"
