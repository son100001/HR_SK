Public Class frmBacTayNghe
    Private Sub frmBacTayNghe_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If tvcn.SaveByStore(QuyenHRFORM, HRFORM_TableName, "[dbo].[usp_InsertUpdateHR_BacTayNghe]", TableLayoutPanel2, ErrorProvider1) Then
            Search()
        End If
        Nhom.Select()
    End Sub
    ...
    End Sub
    Private Sub Search()
        Dim QR As String = "select * from HR_BacTayNghe"
