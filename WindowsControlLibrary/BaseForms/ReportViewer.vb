...
#End Region
    ...
    Public Overloads Sub RefreshReport()
        Me.ShowReport(strReportFile, pValues)
    End Sub
    ...
    Private Sub ReportViewer_Refresh(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
