...
-- Description: Load danh sach phu cap dac biet trong thang

CREATE FUNCTION [dbo].[udf_ListPhuCapDacbiet]     
(
	@nam int,
	@thang int
) 
...
RETURN (
		...
		left join  
		(
			select * from HR_PhuCapDacBiet where nam= @nam and thang=@thang
