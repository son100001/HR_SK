...
CREATE PROCEDURE [dbo].[sp_GetAllInformationInTable] 
	-- Add the parameters for the stored procedure here
	--exec [dbo].[sp_GetAllInformationInTable] 'HR_EmpRegisterNumberOfWDPerMonth'
...
BEGIN
	...
	select tableInf.*,iden.name as IdentityName,pri.ColumnName as PrimaryName from
