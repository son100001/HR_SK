CREATE PROCEDURE [dbo].[usp_InsertUpdateHR_WTDaily]
--exec usp_InsertUpdateHR_WTDaily N's000087','2019-10-31','wt1','NhapTay','1',null,'2019-11-13 14:29:40',N'admin'
...
BEGIN
	...
	set @ThongBao=[dbo].[udf_KiemTraNhapDuLieuChung](@Employee_ID,@Ngay,@UserName,'HR_WTDaily')
	if @thongbao='' begin
		IF not EXISTS(SELECT Employee_ID FROM [dbo].[HR_WTDaily] WHERE Employee_ID = @Employee_ID AND MaCong = @MaCong and Ngay=@Ngay and wt=@wt and InsertSource=@InsertSource)
		BEGIN
