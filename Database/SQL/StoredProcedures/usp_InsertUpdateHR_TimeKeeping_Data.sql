CREATE PROCEDURE [dbo].[usp_InsertUpdateHR_TimeKeeping_Data] 
...
BEGIN
	...
	set @ThongBao=[dbo].[udf_KiemTraNhapDuLieuChung](@Employee_ID,@AccessDate,@UserName,'HR_TimeKeeping_Data')
	if @thongbao='' begin
	...
	select @ID=ID from HR_TimeKeeping_Data where Employee_ID=@Employee_ID and AccessTime=@AccessTime
