CREATE PROCEDURE [dbo].[sp_LuongCoBan_byStep]               
...
End
select Employee_ID,PayGrade,PayStep,isnull(MucLuong,0) as MucLuong from #tb_LuongCoBan
--exec [dbo].[sp_LuongCoBan_byStep] '2019-05-1', '2019-05-31'
